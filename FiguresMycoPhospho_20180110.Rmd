...
# Order sites:
int$Phosphosite <- factor(as.character(int$Phosphosite), levels = int$Phosphosite[order(tab$Intensity.K_Vs_Intensity.P_FC[tab$Significant_KVsP & tab$Significant_LVsP])])
